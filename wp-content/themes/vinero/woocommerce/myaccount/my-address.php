...
<?php foreach ( $get_addresses as $name => $title ) : ?>
		...
		<div class="col-md-6 vl-address">
			<header class="woocommerce-Address-title title">
				<h3><?php echo $title; ?></h3>
				<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', $name ) ); ?>" class="edit"><?php _e( 'Edit', 'vinero' ); ?></a>
			</header>
			<address>
				<?php
					...
					if ( ! $formatted_address )
						_e( 'You have not set up this type of address yet.', 'vinero' );
					else
