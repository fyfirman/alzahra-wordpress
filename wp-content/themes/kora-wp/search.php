        ...
        <div class="container">
            <ul class="text-center">
                ...
                while(have_posts()): the_post();
                    $post_animations_type = get_field('post_animations_type');
                    $post_animation_duration = get_field('post_animation_duration'); ?>
                ...
                <p><?php esc_attr_e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'kora-wp' ); ?></p>
                <?php endif; ?>
            </ul>
            <!-- Pagination -->
