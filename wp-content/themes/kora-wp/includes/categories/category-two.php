<div class="blog-page blog-style-2 section-150px">
    <div class="container">
        <ul class="text-center">
            <?php while(have_posts()): the_post();
                ...
                if(has_post_thumbnail()){
                    $parallax = 'style="background: url('.get_feature_image_url(get_the_ID()).') fixed no-repeat;"';
                } else {
                    $parallax = 'style="background: rgba(0, 0, 0, 0.8);"';
                }?>
                <li class="animate <?php echo esc_attr($post_animations_type); ?>" data-wow-delay="<?php echo esc_attr($post_animation_duration); ?>s" <?php echo ' '.$parallax; ?>>
                    <article>
