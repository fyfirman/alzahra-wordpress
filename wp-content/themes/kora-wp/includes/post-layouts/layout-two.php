                ...
                <?php while(have_posts()): the_post();
                    ...
                    <?php if($post_sidebar_position == 'left'){ ?>
                        ...
                        <div class="col-md-3">
                            ...
                            if($hide_author != 1){ ?>
                                <p><?php esc_html_e('By','kora-wp'); ?> <span class="text-dark"> <?php the_author(); ?></span></p>
                            <?php } if($hide_date != 1){ ?>
                                <p><?php echo get_the_time('M d Y'); ?></p>
                            <?php } if($hide_category != 1){ ?>
                                <p><?php $cats = get_the_category(get_the_ID());
                                    if(is_array($cats)){
                                        $i = 0;
                                        $len = count($cats);
                                        foreach($cats as $cat){
                    ...
                    <div class="col-md-9">
                        <?php if(has_post_thumbnail()){ ?>
                            <img class="img-responsive margin-bottom-30" src="<?php echo get_feature_image_url(get_the_ID()); ?>" alt="">
                        <?php } the_content(); ?>
                        <div class="clear"></div>
                        <?php posts_nav_link(); ?>
